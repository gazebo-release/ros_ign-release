## ros_gz (iron) - 0.245.0-1005

The packages in the `ros_gz` repository were released into the `iron` distro by running `/usr/bin/bloom-release --no-pull-request --rosdistro iron --track iron_gzgarden --override-release-repository-url https://github.com/gazebo-release/ros_ign-release ros_gz` on `Thu, 05 Oct 2023 17:13:17 -0000`
...
The packages in the `ros_gz` repository were released into the `iron` distro by running `/usr/bin/bloom-release --no-pull-request --rosdistro iron --track iron_gzgarden --override-release-repository-url https://github.com/gazebo-release/ros_ign-release ros_gz` on `Thu, 05 Oct 2023 15:16:33 -0000`
...
## ros_gz (humble) - 0.244.11-1002

The packages in the `ros_gz` repository were released into the `humble` distro by running `/usr/bin/bloom-release --no-pull-request --rosdistro humble --track humble_gzgarden --override-release-repository-url https://github.com/gazebo-release/ros_ign-release ros_gz` on `Thu, 08 Jun 2023 20:24:47 -0000`
...
- old version: `0.244.11-1001`
- new version: `0.244.11-1002`
...
## ros_gz (humble) - 0.244.11-1001

The packages in the `ros_gz` repository were released into the `humble` distro by running `/usr/bin/bloom-release --no-pull-request --rosdistro humble --track humble_gzgarden --override-release-repository-url https://github.com/gazebo-release/ros_ign-release ros_gz` on `Thu, 08 Jun 2023 15:40:48 -0000`
...
- release repository: https://github.com/ros2-gbp/ros_ign-release.git
- rosdistro version: `0.244.11-1`
- old version: `0.244.11-1000`
- new version: `0.244.11-1001`
